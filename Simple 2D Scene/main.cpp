...
void update() {
    ...
    g_square_matrix = glm::mat4(1.0f);
    g_square_matrix = glm::translate(g_square_matrix, glm::vec3(g_model_x-2.0f, g_model_y, 0.0f));
    ...
    g_hexagon_matrix = glm::mat4(1.0f);
    g_hexagon_matrix = glm::translate(g_hexagon_matrix, glm::vec3(-g_model_x+2.0f, g_model_y, 0.0f));
